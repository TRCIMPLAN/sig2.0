<?php
/**
 * TrcIMPLAN CANACO - PaginaInicial Organizacion
 *
...
class Organizacion extends \Base\SchemaGovernmentOrganization {
    ...
    public function html() {
        ...
        if ($this->onTypeProperty != '') {
            $a[] = "  <div class=\"organizacion\" itemprop=\"{$this->onTypeProperty}\" itemscope itemtype=\"http://schema.org/GovernmentOrganization\">";
        } else {
            $a[] = '  <div class="organizacion" itemscope itemtype="http://schema.org/GovernmentOrganization">';
        }
        // Propiedad image
        if ($this->image != '') {
